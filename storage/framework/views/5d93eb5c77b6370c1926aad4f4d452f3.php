<tr class="align-middle">    <td><input type="text" class="form-control" placeholder="<?php echo e(__('Enter Icon')); ?>" name="side_content[list][<?php echo e($key); ?>][icon]"></td>    <td><input type="text" class="form-control" placeholder="<?php echo e(__('Enter Text')); ?>" name="side_content[list][<?php echo e($key); ?>][text]"></td>    <td class="text-center"><button class="btn btn-danger text-white delete-field" type="button"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
...
<?php endif; ?> <?php echo e(__('Delete')); ?></button></td></tr><?php /**PATH /Users/apple/Documents/gratech/resources/views/backend/services/partials/side-content-row.blade.php ENDPATH**/ ?>